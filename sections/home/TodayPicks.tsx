...
function TodayPicks({ data }: Props) {
  return (
    <>
      ...
      <div className="bg-third py-24 px-5">
        <div className="container mx-auto flex justify-between items-center gap-8 flex-col md:flex-row">
          ...
          <div className="basis-[48%] rounded-4xl overflow-hidden relative text-center p-20 bg-secondary">
            <h2 className="text-primary text-3xl font-semibold tracking-wide">
              What's in menu
            </h2>
            <p className="mt-5 mb-8 text-primary text-lg leading-6">
              Retingiush your caffine thirst with the most premium caffine you
              can drain
            </p>
