...
const schema = z.object({
  phone: z.string().min(8, "Phone Number must be at least 8 characters").max(11, "Phone Number must be at most 11 characters"),
    ...
    <section className="bg-secondary py-24 px-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-4xl mx-auto">
            ...
            <div>
              ...
              />
              {errors.message && errors.message.message && <p className="text-sm text-red-500 bg-third py-1 px-2 rounded-3xl w-fit">{errors.message.message}</p>}
            </div>
